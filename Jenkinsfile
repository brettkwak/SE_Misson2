	...
	stages {
		...
		stage('Build') {
			steps {
				...
				bat"""javac -cp "../lib/junit-platform-console-standalone-1.7.1.jar" -encoding UTF-8 -d classes BookSearch/src/BookSearch.java BookSearch/src/BookSearchTest.java"""
			}
		}
		stage('Test') {
			steps {
